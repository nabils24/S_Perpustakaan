...
package view.components.pages.author;
...
public class authorView {
    ...
    public authorView(bookController bookController, memberController memberController) {
        this.bookController = bookController;
        this.memberController = memberController;
    }

    public Scene createAuthorScene(Stage primaryStage, String id) {
        ...
        Label titleLabel = new Label("Halo Author");
        ...
        sidebar.getChildren().addAll(headerBox, menuTitle, dashboardBtn, manageBooksBtn, spacer,  logoutBtn);
    ...
    private VBox createDashboardContent() {
        ...
        String name = memberController.getAuthorById(idMhs).getName();
    ...
    private void setupBooksTable(TableView<Book> booksTable) {
        ...
        booksTable.getColumns().addAll(codeCol, titleCol, authorCol, yearCol, approvedCol);
    ...
    private void refreshBooksTable(TableView<Book> booksTable) {
        ...
        List<Book> books = bookController.getBooksByAuthorId(idMhs);
